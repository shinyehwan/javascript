...
// 분리된 routes(home, contacts)은 index.js의 app.use 함수에서 require를 통해 home.js, contacts.js와 연결됩니다. 
// 기존의 DB schema는 route 파일안에서만 사용되기 때문에 index.js에서는 require를 하지 않고, 해당 route안에서 require됩니다.
